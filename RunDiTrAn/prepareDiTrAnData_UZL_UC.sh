...
docker pull harbor.athenafederation.org/distributed-analytics/analysis-table-generator-uc:1.1.5
docker pull harbor.athenafederation.org/athena-restricted/ditran-data-pipeline-uc:1.5.3
